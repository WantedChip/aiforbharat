            ...
            {selectedSchemeId ? (
                <div className="max-w-4xl mx-auto py-10 px-4">
                    <Button
                        ...
                        className="mb-4 px-0 hover:bg-transparent hover:text-green-600 text-gray-500"
                    >
                        &larr; Back to Schemes
                    </Button>
                    <SchemeCard
                        {...MOCK_SCHEMES.find(s => s.scheme_id === selectedSchemeId)!}
                                    ...
                                    <div className="grid md:grid-cols-2 gap-4">
                                        {eligibleSchemes.map((s) => (
                                            <SchemeCard
                                                ...
                                                {...s}
                                                compact={true}
                                                onClickCard={() => setSelectedSchemeId(s.scheme_id)}
                                                onApply={() => showToast("Redirecting to official portal...")}
                                            />
                                        ))}
                                    </div>
                            ...
                            <div className="grid md:grid-cols-2 gap-4">
                                {MOCK_SCHEMES.map((scheme) => (
                                    <SchemeCard
                                        ...
                                        {...scheme}
                                        compact={true}
                                        onClickCard={() => setSelectedSchemeId(scheme.scheme_id)}
                                        onApply={() => showToast("Redirecting to official portal...")}
                                    />
                                ))}
                            </div>
